...
const services = [
  {
    ...
    desc: "WhatsApp, SMS ve e-posta üzerinden otomatik randevu hatırlatma, no-show azaltma, geri bildirim toplama. Hastaya doğum günü, takip, kontrol mesajları otomatik atılır. Kliniğin telefonu zile basmaktan kurtulur.",
    tools: ["n8n", "Twilio", "WhatsApp Business API", "Google Calendar"],
  },
  {
    n: "02",
    title: "AI Asistan & Sık Sorulan Sorular",
    desc: "Web sitenizde 7/24 çalışan, sadece sizin kliniğinizin tonunu bilen Türkçe Claude/GPT asistanı. Randevu alımı, fiyat sorgulama, tedaviye dair temel sorulara cevap verir; karmaşık durumda sekretere yönlendirir.",
    tools: ["Claude API", "OpenAI", "Anthropic SDK", "Custom Knowledge Base"],
  },
  {
    n: "03",
    title: "KVKK Uyumlu Dijital Altyapı",
    desc: "Hasta verisinin toplandığı her form, hukuki açıdan KVKK uyumlu. Aydınlatma metni, açık rıza, veri saklama politikası, veri silme talepleri otomatik yönetilir. Kendi açık kaynaklı KVKK tarayıcım (Avukat MCP) ile sürekli denetim.",
    tools: ["Avukat MCP", "WordPress KVKK eklentileri", "Google reCAPTCHA"],
  },
  {
    n: "04",
    title: "Hasta Takip & Pano Sistemi",
    desc: "Hasta yolculuğunu görseller: ilk başvuru → randevu → tedavi → kontrol → tavsiye. Kliniğin gelirini, doluluk oranını, hekim bazlı verimliliği tek bakışta görürsünüz. Excel'den AI destekli panele geçiş.",
    tools: ["Google Sheets", "Looker Studio", "Supabase", "BigQuery"],
  },
  {
    n: "05",
    title: "İçerik Üretim Pipeline'ı",
    desc: "Sosyal medya postu, blog yazısı, hasta bilgilendirme videosu — hepsi yarı otomatik. Konuyu söylersiniz; AI script yazar, ses sentezi yapar, video kurgular. Haftalık içerik takvimi 30 dakikada hazırlanır.",
    tools: ["Claude", "ElevenLabs", "Suno", "FFmpeg", "n8n"],
  },
  {
    n: "06",
    title: "Web Sitesi & SEO",
    desc: "WordPress veya Next.js tabanlı, mobil uyumlu, hızlı, KVKK uyumlu klinik web sitesi. Yerel SEO ile Google'da ilk sayfa: \"Kadıköy diş hekimi\", \"Bakırköy psikolog\" gibi aramalarda görünürlük.",
    tools: ["WordPress", "Avada", "Next.js", "Google Search Console", "Schema.org"],
  },
  {
    n: "07",
    title: "Eğitim & Mini Kurslar",
    desc: "Hastalarınıza özel mini-kurslar, broşürler, video setleri. \"Diş protezi sonrası bakım\", \"Stres yönetimi 5 günde\", \"İmplant öncesi hazırlık\" gibi materyaller, danışanın kendine yatırım hissini artırır.",
    tools: ["Notion", "Udemy", "Teachable", "Camtasia"],
  },
  {
    n: "08",
    title: "Veri Güvenliği & Yedekleme",
    desc: "Hasta verisi şifreli, yedekli, KVKK'ya uygun şekilde saklanır. Sızıntı durumunda uyarı sistemi. Sızıntı testi (etik hacker MCP) ile düzenli denetim. Sigorta gerektirebilecek kötü senaryolara karşı koruma.",
    tools: ["Backblaze", "Cloudflare", "Etik Hacker MCP", "1Password"],
  },
];
